...
int main() {
  ...
  */
  ...
  //LIFT GROUP TESTING - CODE BUTTONS
...
/*
    if (Controller1.ButtonB.pressing())
      LiftGroup.rotateTo(-1.7, rotationUnits::rev, 10, velocityUnits::pct);
      */
    task::sleep(20);
    ...
    if (Controller1.ButtonL1.pressing()) {
      SpinMotor(SideLiftMotor, 10000000000, directionType::rev); 
    }
    else if (Controller1.ButtonL2.pressing())
      SpinMotor(SideLiftMotor, 10000000000);
    else
      SideLiftMotor.stop(brakeType::hold);
